...
import type { TooltipProps } from "recharts"; // Add this import at the top if not present

const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  Omit<TooltipProps<any, any>, "payload" | "label"> &
    React.ComponentProps<"div"> & {
      payload?: any[]; // Explicitly type payload as an array
      hideLabel?: boolean
      hideIndicator?: boolean
      indicator?: "line" | "dot" | "dashed"
      nameKey?: string
      labelKey?: string
      label?: any // Add label prop explicitly
    }
>(
  (
    {
